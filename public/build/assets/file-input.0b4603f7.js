import{m as ne,f as ae,V as oe}from"./VField.80b1d26d.js";import{m as ie,f as se,a as ce}from"./VInput.b908012d.js";import{f as ue}from"./forwardRefs.c003b6b8.js";import{a3 as pe,an as re,aC as de,ak as me,x as y,c$ as T,s as I,ab as _e,aB as fe,g as e,m as N,F as j,b3 as E,aw as he,ai as ve,o as p,f as r,e as R,z as O,w as a,l as Ve,B as Fe,C as t,j as be,U as V,i as n}from"./main.51d636ad.js";import{V as H}from"./VChip.5dda9d1f.js";import{V as ge}from"./VCounter.3afbc086.js";import{a as c,V as Y}from"./VRow.31030f88.js";import{_ as Ie}from"./AppCardCode.b0576ee1.js";import"./index.0cb5c23c.js";import"./position.86823653.js";import"./router.b3165802.js";import"./easing.36b781ab.js";import"./VImg.7908a52d.js";import"./VBtn.75490eec.js";import"./VAvatar.4d2fb2e9.js";import"./vue.runtime.esm-bundler.0c765d02.js";import"./VCard.b0eb0236.js";import"./VDivider.ce0d143c.js";const u=pe({name:"VFileInput",inheritAttrs:!1,props:{chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},multiple:Boolean,hint:String,persistentHint:Boolean,placeholder:String,showSize:{type:[Boolean,Number],default:!1,validator:l=>typeof l=="boolean"||[1e3,1024].includes(l)},...ie({prependIcon:"$file"}),modelValue:{type:Array,default:()=>[],validator:l=>re(l).every(i=>i!=null&&typeof i=="object")},...ne({clearable:!0})},emits:{"click:control":l=>!0,"update:modelValue":l=>!0},setup(l,i){let{attrs:d,emit:F,slots:o}=i;const{t:h}=de(),m=me(l,"modelValue"),k=y(()=>typeof l.showSize!="boolean"?l.showSize:void 0),S=y(()=>{var s;return((s=m.value)!=null?s:[]).reduce((_,v)=>{let{size:w=0}=v;return _+w},0)}),$=y(()=>T(S.value,k.value)),C=y(()=>{var s;return((s=m.value)!=null?s:[]).map(_=>{const{name:v="",size:w=0}=_;return l.showSize?`${v} (${T(w,k.value)})`:v})}),x=y(()=>{var v;var s;const _=(v=(s=m.value)==null?void 0:s.length)!=null?v:0;return l.showSize?h(l.counterSizeString,_,$.value):h(l.counterString,_)}),B=I(),D=I(),b=I(!1),f=I(),W=y(()=>l.messages.length?l.messages:l.persistentHint?l.hint:"");function A(){if(f.value!==document.activeElement){var s;(s=f.value)==null||s.focus()}b.value||(b.value=!0)}function q(s){E(l["onClick:prepend"],s),U(s)}function U(s){var _;(_=f.value)==null||_.click(),F("click:control",s)}function G(s){s.stopPropagation(),A(),he(()=>{m.value=[],f!=null&&f.value&&(f.value.value=""),E(l["onClick:clear"],s)})}return _e(()=>{const s=!!(o.counter||l.counter),_=!!(s||o.details),[v,w]=fe(d),[{modelValue:yl,...J}]=se(l),[K]=ae(l);return e(ce,N({ref:B,modelValue:m.value,"onUpdate:modelValue":z=>m.value=z,class:"v-file-input","onClick:prepend":q,"onClick:append":l["onClick:append"]},v,J,{focused:b.value,messages:W.value}),{...o,default:z=>{let{isDisabled:P,isDirty:L,isReadonly:Q,isValid:X}=z;return e(oe,N({ref:D,"prepend-icon":l.prependIcon,"onClick:control":U,"onClick:clear":G,"onClick:prependInner":l["onClick:prependInner"],"onClick:appendInner":l["onClick:appendInner"]},K,{active:L.value||b.value,dirty:L.value,focused:b.value,error:X.value===!1}),{...o,default:Z=>{let{props:{class:ee,...le}}=Z;return e(j,null,[e("input",N({ref:f,type:"file",readonly:Q.value,disabled:P.value,multiple:l.multiple,name:l.name,onClick:g=>{g.stopPropagation(),A()},onChange:g=>{var M;if(!g.target)return;const te=g.target;m.value=[...(M=te.files)!=null?M:[]]},onFocus:A,onBlur:()=>b.value=!1},le,w),null),e("div",{class:ee},[m.value.length>0&&(o.selection?o.selection({fileNames:C.value,totalBytes:S.value,totalBytesReadable:$.value}):l.chips?C.value.map(g=>e(H,{key:g,size:"small",color:l.color},{default:()=>[g]})):C.value.join(", "))])])}})},details:_?z=>{var P;return e(j,null,[(P=o.details)==null?void 0:P.call(o,z),s&&e(j,null,[e("span",null,null),e(ge,{active:!!m.value.length,value:x.value},o.counter)])])}:void 0})}),ue({},B,D,f)}}),ye={__name:"DemoFileInputLoading",setup(l){const i=I(),d=I(!0);return ve(i,()=>{d.value=!i.value[0]}),(F,o)=>(p(),r(u,{modelValue:R(i),"onUpdate:modelValue":o[0]||(o[0]=h=>O(i)?i.value=h:null),loading:R(d),color:"primary",label:"File input"},null,8,["modelValue","loading"]))}},Ce={__name:"DemoFileInputSelectionSlot",setup(l){const i=I([]);return(d,F)=>(p(),r(u,{modelValue:R(i),"onUpdate:modelValue":F[0]||(F[0]=o=>O(i)?i.value=o:null),multiple:"",placeholder:"Upload your documents",label:"File input","prepend-icon":"tabler-paperclip"},{selection:a(({fileNames:o})=>[(p(!0),Ve(j,null,Fe(o,h=>(p(),r(H,{key:h,label:"",size:"small",variant:"outlined",color:"primary",class:"me-2"},{default:a(()=>[t(be(h),1)]),_:2},1024))),128))]),_:1},8,["modelValue"]))}},we={__name:"DemoFileInputValidation",setup(l){const i=[d=>!d||!d.length||d[0].size<1e6||"Avatar size should be less than 1 MB!"];return(d,F)=>(p(),r(u,{rules:i,label:"Avatar",accept:"image/png, image/jpeg, image/bmp",placeholder:"Pick an avatar","prepend-icon":"tabler-camera"}))}},ze={};function ke(l,i){return p(),r(u,{"show-size":"",label:"File input"})}const Se=V(ze,[["render",ke]]),$e={};function Be(l,i){return p(),r(u,{label:"File input","prepend-icon":"tabler-camera"})}const De=V($e,[["render",Be]]),Pe={};function je(l,i){return p(),r(u,{multiple:"",label:"File input"})}const xe=V(Pe,[["render",je]]),Ae={};function Ne(l,i){return p(),r(u,{"show-size":"",counter:"",multiple:"",label:"File input"})}const Re=V(Ae,[["render",Ne]]),Ue={};function Le(l,i){return p(),r(u,{chips:"",label:"File input w/ chips"})}const Me=V(Ue,[["render",Le]]),Te={};function Ee(l,i){return p(),r(u,{accept:"image/*",label:"File input"})}const Oe=V(Te,[["render",Ee]]),He={};function Ye(l,i){return p(),r(Y,null,{default:a(()=>[e(c,{cols:"12",sm:"6"},{default:a(()=>[e(u,{label:"Outlined"})]),_:1}),e(c,{cols:"12",sm:"6"},{default:a(()=>[e(u,{label:"Filled",variant:"filled"})]),_:1}),e(c,{cols:"12",sm:"6"},{default:a(()=>[e(u,{label:"Solo",variant:"solo"})]),_:1}),e(c,{cols:"12",sm:"6"},{default:a(()=>[e(u,{label:"Plain",variant:"plain"})]),_:1}),e(c,{cols:"12",sm:"6"},{default:a(()=>[e(u,{label:"Underlined",variant:"underlined",density:"default"})]),_:1})]),_:1})}const We=V(He,[["render",Ye]]),qe={};function Ge(l,i){return p(),r(u,{label:"File input",density:"compact"})}const Je=V(qe,[["render",Ge]]),Ke={};function Qe(l,i){return p(),r(u,{label:"File input"})}const Xe=V(Ke,[["render",Qe]]),Ze={ts:`<template>
  <VFileInput
    accept="image/*"
    label="File input"
  />
