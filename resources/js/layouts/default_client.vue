...
const DefaultLayoutWithHorizontalNav = defineAsyncComponent(() => import('./components/client/DefaultLayoutWithHorizontalNav.vue'))
const DefaultLayoutWithVerticalNav = defineAsyncComponent(() => import('./components/client/DefaultLayoutWithVerticalNav.vue'))
