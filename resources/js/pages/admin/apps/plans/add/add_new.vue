...
const logo = ref('')
const price = ref('0')
const count_emp = ref('0')
const count_branch = ref('0')
const count_interval = ref('0')
...
const sendFrom = () => {
  ...
  refForm.value?.validate().then(({ valid: isValid }) => {
    ...
    if (isValid) {
      loading.value = true
      disabled.value = true
      axios.post('add/plans', {
        name_en: name_en.value,
        name_ar: name_ar.value,
        price: price.value,
        count_emp: count_emp.value,
        count_branch: count_branch.value,
        count_interval: count_interval.value,
        logo: logo.value,
